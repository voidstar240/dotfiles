# Is this needed in ZSH? (Ported from .bashrc)
...
# Use history then completion autosuggestions
...
ZSH_THEME_GIT_PROMPT_BEHIND="%b%F{8}↓"
ZSH_THEME_GIT_PROMPT_AHEAD="%b%F{8}↑"
...
alias vim='nvim'
alias term='(nohup alacritty --working-directory $PWD >/dev/null 2>&1 &)'
alias term-solid='(nohup alacritty --working-directory $PWD -o "window.opacity=1.0" >/dev/null 2>&1 &)'
alias fetch='fastfetch && cpufetch'
alias blkmnt='lsblk -rno MOUNTPOINTS'
